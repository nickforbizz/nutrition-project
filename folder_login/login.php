...
<div class="" style="position:fixed;height:100%;width:100%;background-image:url(../img/hot_air_balloon-wallpaper-1920x1080.jpg);z-index:-1;filter:blur(5px)">
...
<?php
	...
	//Checking is user existing in the database or not
		...
		$result = $conn->query($query) or die($conn2->error());
		while ($a = $result->fetch_assoc()) {
			...
			?>
			<script type="text/javascript">
			window.location="./../the_dashboard/pages/index.html";
			</script>
			<?php
			//
